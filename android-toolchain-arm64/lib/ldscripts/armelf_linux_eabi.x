...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/l2/sources/crosstool-ng-by-dorimanx/builds/aarch64-SAGIT-linux-android/aarch64-SAGIT-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
